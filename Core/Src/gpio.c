...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, CHARGE_CTRL_Pin|DISCHARGE_CAP1_Pin|DISCHARGE_CAP2_Pin|DISCHARGE_CAP3_Pin
  ...
  HAL_GPIO_WritePin(GPIOB, WELD_PULSE_Pin|TFT_BLK_Pin|TFT_CS_Pin|TFT_DC_Pin
                          |TFT_RES_Pin|BUZZER_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : CHARGE_CTRL_Pin DISCHARGE_CAP1_Pin DISCHARGE_CAP2_Pin DISCHARGE_CAP3_Pin
                           DISCHARGE_CAP4_Pin */
  GPIO_InitStruct.Pin = CHARGE_CTRL_Pin|DISCHARGE_CAP1_Pin|DISCHARGE_CAP2_Pin|DISCHARGE_CAP3_Pin
                          |DISCHARGE_CAP4_Pin;
